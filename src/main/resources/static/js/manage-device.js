...
if (updateDeviceForm) {
  updateDeviceForm.addEventListener("submit", (e) => {
    ...
    let timeCheckDocs = document.getElementsByName("time_check");  // CÁC input time
    let timeChecks = []; //list chứa các HẸN GIỜ
    let i = 1;
    ...
    let dataToUpdate = {
      ...
      temperatureThreshold,
      pumpTimeMinute,
      timeChecks, // mảng các json các HẸN GIỜ
    };
